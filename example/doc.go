...
// streaming output, conditional graphs, and diagrams. They intentionally use
// only public APIs and are run by "go test", so the documentation cannot
// silently drift away from the library.
//
