...
func TestFanOut(t *testing.T) {
	nodes := []core.Node[int, int]{
		core.NodeFunc[int, int](func(_ context.Context, x int) (int, error) { return x + 1, nil }),
		core.NodeFunc[int, int](func(_ context.Context, x int) (int, error) { return x + 2, nil }),
		core.NodeFunc[int, int](func(_ context.Context, x int) (int, error) { return x + 3, nil }),
	}
...
func TestFanOutAllN_collectsResults(t *testing.T) {
	...
	ok := core.NodeFunc[int, int](func(_ context.Context, in int) (int, error) { return in + 1, nil })
	bad := core.NodeFunc[int, int](func(_ context.Context, in int) (int, error) { return in, boom })
...
func TestMapAll_collect(t *testing.T) {
	...
	for name, mapper := range map[string]core.Node[[]int, []flowx.Result[int]]{
...
func TestFanOutAll_collectsFailures(t *testing.T) {
	boom := errors.New("boom")
	nodes := []core.Node[int, int]{
		core.NodeFunc[int, int](func(_ context.Context, in int) (int, error) { return in + 1, nil }),
...
func TestCombine2(t *testing.T) {
	length := core.NodeFunc[string, int](func(_ context.Context, s string) (int, error) { return len(s), nil })
	upper := core.NodeFunc[string, string](func(_ context.Context, s string) (string, error) { return s + "!", nil })
...
func TestRace_firstWins(t *testing.T) {
	slow := core.NodeFunc[int, int](func(ctx context.Context, x int) (int, error) {
		select {
		case <-ctx.Done():
			return 0, ctx.Err()
	...
	fast := core.NodeFunc[int, int](func(_ context.Context, x int) (int, error) { return x * 100, nil })
...
func TestRace_allFail(t *testing.T) {
	...
	n1 := core.NodeFunc[int, int](func(_ context.Context, _ int) (int, error) { return 0, e1 })
	n2 := core.NodeFunc[int, int](func(_ context.Context, _ int) (int, error) { return 0, e2 })
...
func TestChain_emptyAndSingle(t *testing.T) {
	...
	node := core.NodeFunc[int, int](func(_ context.Context, in int) (int, error) { return in + 1, nil })
...
func TestFanOut_clonesNodes(t *testing.T) {
	...
	nodes[0] = core.NodeFunc[int, int](func(_ context.Context, in int) (int, error) { return in + 100, nil })
...
func TestRace_allFailErrorOrderIsStable(t *testing.T) {
	...
	n1 := core.NodeFunc[int, int](func(_ context.Context, _ int) (int, error) {
